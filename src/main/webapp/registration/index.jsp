    ...
    <%
        if (request.getAttribute("nick_name") != null) {
            out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                                ...
                                "   <h5>User '" + request.getAttribute("nick_name") + "' added!</h5>\n" +
                                "</div>");
        }
    %>
    <div class="w3-card-4">
        ...
        <form id="submitform" action="/registration/to-register" method="post" class="w3-selection w3-light-grey w3-padding">
            <label>First name:
                <input type="text" name="first_name" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br/>
            </label>

            <label>Last name:
                <input type="text" name="last_name" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br/>
            </label>

            <label>Nick name:
                <input type="text" name="nick_name" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br/>
            </label>
