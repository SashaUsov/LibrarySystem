...
<details>
    ...
    <form id="submitform" action="/book/search-by-title" method="get" class="w3-selection w3-light-grey w3-padding">
        <input type="text" name="book_title" class="w3-input w3-animate-input w3-border w3-round-large"
               style="width: 30%"><br/>
...
<details>
    ...
    <form id="submitform2" action="/book/search-by-author" method="get" class="w3-selection w3-light-grey w3-padding">
        <input type="text" name="book_author" class="w3-input w3-animate-input w3-border w3-round-large"
               style="width: 30%"><br/>
        <button type="submit" class="w3-btn w3-green w3-round-large w3-margin-bottom">Find</button>
    </form>
...
<details>
    ...
    <form id="submitform3" action="/book/search-by-genre" method="get" class="w3-selection w3-light-grey w3-padding">
