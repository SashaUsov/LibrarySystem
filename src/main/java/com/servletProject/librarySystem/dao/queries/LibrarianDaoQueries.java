...
public class LibrarianDaoQueries {
    ...
    public static final String UPDATE_INCREMENT_BOOK_TOTAL_AMOUNT = "UPDATE book_catalog SET total_amount= total_amount + 1\n" +
                                                "WHERE id= ?;";

    public static final String UPDATE_DECREMENT_BOOK_TOTAL_AMOUNT = "UPDATE book_catalog SET total_amount= total_amount - 1\n" +
                                                "WHERE id= ?;";
    ...
    public static final String FIND_BOOK_COPY_BY_BOOK_ID = "SELECT id FROM copies_of_books WHERE id_book= ? AND availability= ?";
